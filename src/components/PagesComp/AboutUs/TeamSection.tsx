        ...
        <div className=" relative z-10 w-full px-6 lg:px-16 lg:px-24 max-w-[80rem] mx-auto pb-16 pt-16 lg:pt-16">
            ...
            <div ref={infoRef} className={`mt-10 grid grid-cols-1 lg:grid-cols-3 gap-8`}>
                <div className={`transition-all duration-500 lg:duration-700 ${infoInView ? 'lg:opacity-100 lg:translate-y-0' : 'lg:opacity-0 lg:translate-y-2'}`}>
                    <h3 style={{ fontWeight: 300 }} className='text-[#0B0B0B] text-[18px] lg:text-[40px] '>Who We Are:</h3>
                    <p className='text-[#0B0B0B] text-[14px] leading-[24px] lg:text-[16px] font-light lg:max-w-[200px]'>A team of data scientists, engineers, and strategists with AI expertise.</p>
                </div>
                <div className={`transition-all duration-500 lg:duration-700 delay-100 ${infoInView ? 'lg:opacity-100 lg:translate-y-0' : 'lg:opacity-0 lg:translate-y-2'}`}>
                    <h3 style={{ fontWeight: 300 }} className='text-[#0B0B0B] text-[18px] lg:text-[40px] '>How We Work:</h3>
                    <p className='text-[#0B0B0B] text-[14px] leading-[24px] lg:text-[16px] font-light lg:max-w-[200px]'>Collaborative, research-driven, and focused on measurable outcomes.</p>
                </div>
                <div className={`transition-all duration-500 lg:duration-700 delay-200 ${infoInView ? 'lg:opacity-100 lg:translate-y-0' : 'lg:opacity-0 lg:translate-y-2'}`}>
                    <h3 style={{ fontWeight: 300 }} className='text-[#0B0B0B] text-[18px] lg:text-[40px] '>Setting Us Apart:</h3>
                    <p className='text-[#0B0B0B] text-[14px] leading-[24px] lg:text-[16px] font-light lg:max-w-[200px]'>Industry knowledge + cutting-edge AI R&D + customer-first approach.</p>
                </div>
            </div>
            <div className='mt-24 grid grid-cols-1 lg:grid-cols-2   lg:grid-cols-3 justify-center gap-4 lg:max-w-6xl mx-auto'>
                {teamMembersDetails?.map((member: TeamMember) => (
                    <div
                        key={member.id}
                        id={member.id.toString()}
                        className='group relative   rounded-[14.5px] flex flex-col justify-between h-auto lg:h-[400px] min-w-[228px] min-w-[300px] overflow-hidden'
                        style={{
                            background:
                    ...
                    >
                        ...
                        <div className='p-4 relative z-20 opacity-100 lg:opacity-0 translate-y-0 lg:translate-y-2 transition duration-150 ease-out lg:group-hover:opacity-100 lg:group-hover:translate-y-0' style={{ willChange: 'opacity, transform' }}>
