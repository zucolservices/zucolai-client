...
export default function GetInTouchSection() {
  ...
  return (
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-32 flex flex-col justify-center items-center px-4 sm:px-6 md:px-12 lg:px-20 bg-white overflow-hidden min-h-[70vh] sm:min-h-[80vh]">
      ...
      <div className="relative text-left z-10 w-full max-w-xs sm:max-w-lg md:max-w-2xl flex flex-col justify-center items-center" ref={sectionRef}>
        ...
        <div className="w-full flex sm:flex-row gap-4 sm:gap-6 mt-8 sm:mt-10 md:mt-12 justify-start">
