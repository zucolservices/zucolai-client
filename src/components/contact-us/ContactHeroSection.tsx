  ...
  <div className="relative z-10 w-full h-screen">
    <div className="flex flex-col-reverse lg:flex-row w-full h-full">
      ...
      <div className="lg:w-[60%] lg:h-screen justify-center flex flex-col px-[16.5px] py-8 lg:py-0 lg:px-[80px]">
        ...
        <h1 className="text-[32px] lg:text-[40px] lg:text-[44px] font-light leading-[40px] lg:leading-[48px] lg:leading-[52px] text-[#FDFDFD] mb-4 lg:mb-6 tracking-[-0.02em] font-['Inter Display']">
